...
public class AddJenkinsPipelineTest extends BaseTest {
        ...
        public void createMultiConfigProject() {
            ...
            getDriver().findElement(By.linkText("New Item")).click();
             ...
             getDriver().findElement(By.cssSelector("#main-panel > form > div.config-table > section:nth-child(4) > div:nth-child(9) > div.help-sibling.tr.optional-block-start.row-group-start.row-set-start > div > span > label")).click();
