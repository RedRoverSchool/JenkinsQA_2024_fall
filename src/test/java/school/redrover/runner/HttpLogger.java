...
public class HttpLogger {
    ...
    public static void logRequestAndResponse(HttpPost httpPost, CloseableHttpResponse response) throws IOException {
        String requestUri = httpPost.getURI().toString();
