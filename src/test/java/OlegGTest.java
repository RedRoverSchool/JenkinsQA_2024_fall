...
public class OlegGTest {
    ...
    public static void searchCartCompareTest() throws InterruptedException {
        ...
        Thread.sleep(500);
        goodBrandInSearch = driver.findElement(By.xpath("//article[@id='c268672333']//span[@class='product-card__brand']")).getText();
        goodInSearch = driver.findElement(By.xpath("//article[@id='c268672333']//span[text()='14T 12 512GB, Blue Black            ']"))
                .getText().substring(2);
        goodFullNameInSearch = goodBrandInSearch + " " + goodInSearch;

        priceWithWalletFromSearch = Integer.parseInt(driver.findElement(By.xpath("//article[@id='c268672333']//span/ins[@class='price__lower-price wallet-price']"))
    ...
    public static void cartSummingTest() throws InterruptedException {
        ...
        priceSecondItem = Integer.parseInt(driver.findElement(By.xpath("//article[@id='c266736655']//span/ins[@class='price__lower-price']"))
                .getText().replaceAll(" ", "").replaceAll("₽", ""));
        if(driver.findElement(By.xpath("/html/body/div[4]/div/div/div/button[@class='cookies__btn btn-minor-md']")) != null) {
            driver.findElement(By.xpath("/html/body/div[4]/div/div/div/button[@class='cookies__btn btn-minor-md']")).click();
        }
        ...
        driver.findElement(By.xpath("//article[@id='c268672333']//a[@class='product-card__add-basket j-add-to-basket btn-main']")).click();
        Thread.sleep(500);
        driver.findElement(By.xpath("//article[@id='c266736655']//a[@class='product-card__add-basket j-add-to-basket btn-main']")).click();
        Thread.sleep(500);
        cartCount = Integer.parseInt(driver.findElement(By.xpath("//*[@id='basketContent']//span[@class='navbar-pc__notify']"))
                .getText());
        ...
        driver.findElement(By.xpath("//*[@id='basketContent']//a[@data-wba-header-name='Cart']")).click();
        Thread.sleep(3000);
        priceFirstItem = Integer.parseInt(driver.findElement(By.xpath("//div[@class='list-item__price-new wallet']"))
                .getText().replaceAll(" ", "").replaceAll("₽", ""));
        overallCartPrice = Integer.parseInt(driver.findElement(By.xpath("//p/span[2]/span[starts-with(@data-link, '{formatMoneyAnim')]"))
                .getText().replaceAll(" ", "").replaceAll("₽", ""));
